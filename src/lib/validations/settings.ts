...
export const createUserSchema = z.object({
  ...
  role: z.enum(["business_owner", "manager", "cashier", "inventory_officer", "accountant"]),
...
export const updateUserSchema = z.object({
  ...
  role: z.enum(["business_owner", "manager", "cashier", "inventory_officer", "accountant"]).optional(),
  phone: z.string().optional(),
